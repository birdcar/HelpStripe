...
idiomatic Laravel — Livewire 4, Flux, Fortify, Reverb, Resend, the Spatie
packages, and SQLite. Every pillar doubles as a Laravel lesson, taught
through annotated source code and one walkthrough doc per phase.
...
| 2 | Ticket Management | Ticket Management | Livewire pages, authorization, activity log timelines, domain events, notifications | [02-ticket-management.md](02-ticket-management.md) |
| 3 | Shared Inbox & Email Pipeline | Shared Inbox | Mailables, inbound webhooks, queues, attachments (medialibrary), artisan commands | [03-shared-inbox.md](03-shared-inbox.md) |
...
| 5 | Knowledge Base | Knowledge Base | Nested resources, slugs (sluggable), drafts, LIKE search | [05-knowledge-base.md](05-knowledge-base.md) |
